<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="SendMessage.aspx.cs" Inherits="SendMessage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <form id="Form1" runat="server">
        ...
        <asp:Button ID="Gonder" runat="server" cssClass="btn btn-info" Text="Gönder" OnClick="Gonder_Click1"/>
    </form>
